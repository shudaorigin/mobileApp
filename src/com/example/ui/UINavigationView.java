...
public class UINavigationView extends LinearLayout {
	...
	private void initAttributes(AttributeSet attributeSet) {
		...
		if (null != attributeSet) {
			...
			final int attrIds[] = new int[] { R.attr.strBtnLeft,
					R.attr.strBtnRight, R.attr.strTitle,
					R.attr.left_drawable, R.attr.right_drawable };

			Context context = getContext();

			TypedArray array = context.obtainStyledAttributes(attributeSet,	attrIds);
	...
	private void initContent() {
		...
		if (left_drawable != 0) {
			...
			btn_left.setBackgroundResource(R.drawable.ic_launcher);// 设置背景
		}
		...
		btn_right.setBackgroundResource(R.drawable.ic_launcher);// 设置背景
